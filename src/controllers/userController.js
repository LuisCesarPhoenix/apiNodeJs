...
/*
Importa a função queryDatabase, que gerencia a conexão sob demanda com o MySQL.
...
async function loginUser(req, res) {
  ...
  try {
    ...
    const user = result[0];
		console.log("Senha enviada pelo usuário:", password); /* Apenas para debug, remova em produção */
		console.log("Senha salva no banco:", user.password); /* Apenas para debug, remova em produção */
